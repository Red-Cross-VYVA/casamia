...
- [ ] Supabase Security Advisor reports no exposed `SECURITY DEFINER` function warnings.
- [ ] Blank consent-evidence row created by the 26 August legacy-deployment smoke check has been identified and deleted.
