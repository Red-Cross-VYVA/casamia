...
try {
  ...
  assert.match(reportEmailRequest.text, /Open: https:\/\/www\.casamia\.com\.es\/estimate\//)
  assert.match(reportEmailRequest.html, />Open<span[^>]*font-size:27px[^>]*>&rarr;<\/span>/)
  assert.doesNotMatch(reportEmailRequest.html, /background:#ffffff;color:#245c16/)
