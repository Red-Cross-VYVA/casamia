...
assertPermanentRedirect('/tools/home-safety-check', '/tools/is-my-parent-safe-at-home')
assertPermanentRedirect('/es/tools/senior-friendly-home-check', '/es/tools/is-my-parent-safe-at-home')
assertPermanentRedirect('/es/tools/home-safety-check', '/es/tools/is-my-parent-safe-at-home')
assertPermanentRedirect('/es/partner', '/partner')
assert.match(vercel, /"source"\s*:\s*"\/order"/)
assert.match(vercel, /"source"\s*:\s*"\/es\/order"/)
