...
SECTIONS = [
    {
        ...
        "items": [
            ...
            item("FIT", "Note every place where the person holds a wall or furniture for balance.", "Anota cada lugar donde la persona se apoya en una pared o mueble para mantener el equilibrio."),
    ...
    },
    {
        ...
        "items": [
            ...
            item("FIT", "Check that any ramp works with the person's usual mobility aid.", "Comprueba que cualquier rampa funciona con la ayuda de movilidad habitual."),
            ...
            item("CHECK", "Confirm the intercom, bell, lift controls and door viewer suit the person's vision, hearing and dexterity.", "Comprueba que telefonillo, timbre, ascensor y mirilla se adaptan a la visión, audición y destreza de la persona."),
    ...
    },
    {
        ...
        "items": [
            ...
            item("FIT", "Check that the person can sit and stand without pulling on a table or unstable object.", "Comprueba que la persona puede sentarse y levantarse sin tirar de una mesa u objeto inestable."),
    ...
    },
    {
        ...
        "items": [
            item("FIT", "Check that the person can sit securely on the bed, place both feet down and stand without pulling furniture.", "Comprueba que puede sentarse con seguridad, apoyar ambos pies y levantarse sin tirar de muebles."),
    ...
    },
    {
        ...
        "items": [
            item("CHECK", "Confirm the person can move between storage, preparation, sink and cooking areas.", "Comprueba que puede moverse entre almacenaje, preparación, fregadero y cocción."),
            ...
            item("CHECK", "Ensure appliance doors do not block the person's standing position or mobility aid.", "Asegura que las puertas de los electrodomésticos no bloquean la postura o ayuda de movilidad."),
...
COPY = {
    "en": {
        ...
        "priority": {
            ...
            "FIT": ("PERSONAL FIT", "The right solution depends on the person and routine."),
        },
        "profile_title": "Person and home snapshot",
        "profile_fields": ["Person name", "Home address", "Date reviewed", "Reviewed with", "Mobility aid used", "Main concern today"],
        ...
        "resident_question": "The activity the person most wants to keep doing independently:",
        ...
        "handover_items": [
            "The person has tried the finished change during the real routine.",
