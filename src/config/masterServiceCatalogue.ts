...
export const masterServiceCatalogue: MasterServiceCatalogue = {
  ...
  outcomes: [
    ...
    outcome('bedroom-safer-walking-routes', 'bedroom', 'home-safety-package', 'bedroom-home-safety-package', 'Safer Walking Routes', 'Rutas de paso más seguras', 'Bedroom and night routes', 'Reducing trip hazards around the bedroom and making the route to the bathroom easier to see at night.', 'Reduce riesgos de tropiezo en el dormitorio y hace más visible el recorrido nocturno hacia el baño.', 'Includes motion-activated night lighting, bedside lighting, loose-rug securing, cable management, furniture repositioning, a clear bed-to-door path and a safer night route to the bathroom.', 'Incluye luz nocturna con sensor de movimiento, iluminación junto a la cama, fijación o retirada de alfombras sueltas, organización de cables, recolocación de muebles, una ruta despejada de la cama a la puerta y un recorrido nocturno más seguro hacia el baño.', 'essential', ['bedroom', 'bathroom', 'lighting', 'living-room'], 140, { legacyId: 'bedroom-night-route', grantEligible: true }),
    ...
    outcome('bedroom-fire-safety', 'bedroom', 'home-safety-package', 'bedroom-home-safety-package', 'Smoke & Fire Safety', 'Seguridad ante humo e incendio', 'Smoke and fire safety', 'Helping protect the bedroom with earlier smoke warning and fire-risk awareness.', 'Ayuda a proteger el dormitorio con aviso temprano de humo y mayor prevención ante riesgo de incendio.', 'Adds a smoke detector so smoke risk can be noticed sooner, especially when someone is resting or asleep.', 'Añade un detector de humo para detectar antes el riesgo, especialmente cuando la persona descansa o duerme.', 'essential', ['bedroom', 'smart-safety'], 160),
    ...
    ...[
      ...
      ['bedroom-door-accessibility', 'Easier Bedroom Door Access', 'Acceso más fácil al dormitorio'],
    ].map(([id, en, es], index) =>
...
function outcomeCapabilityRelations() {
  const map: Record<string, string[]> = {
    ...
    'bedroom-safer-walking-routes': ['bedroom-motion-night-lighting', 'bedside-lighting', 'loose-rug-securing', 'cable-management', 'furniture-repositioning', 'bed-to-door-clear-route', 'bedroom-to-bathroom-route-improvement'],
