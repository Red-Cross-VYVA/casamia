...
export const masterServiceCatalogue: MasterServiceCatalogue = {
  ...
  packages: [
    ...
    packageRecord('bathroom-connected-room', 'bathroom', 'connected-room', {
      ...
      shortDescription: {
        en: 'Consent-aware bathroom support with motion lighting, leak alerts and family notifications where they suit the home.',
    ...
    packageRecord('kitchen-home-safety-package', 'kitchen', 'home-safety-package', {
      ...
      customerBenefit: {
        en: 'A more usable kitchen that supports independence, with setup, installation and final handover included.',
        es: 'Una cocina más usable que apoya la independencia, con configuración, instalación y entrega final incluidas.',
      },
    }),
    ...
    packageRecord('living-room-connected-room', 'living-room', 'connected-room', {
      ...
      shortDescription: {
        en: 'Voice help, reminders, hands-free calls, family notifications and selected room alerts set up for everyday living.',
    ...
    packageRecord('entrance-connected-room', 'entrance', 'connected-room', {
      ...
      shortDescription: {
        en: 'Video door awareness, two-way communication and selected mobile or family alerts set up around the entrance.',
