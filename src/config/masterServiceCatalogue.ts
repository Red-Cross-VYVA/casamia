...
export const masterServiceCatalogue: MasterServiceCatalogue = {
  ...
  outcomes: [
    ...
    outcome('starter-core-priority-rails', 'living-room', 'starter-essentials', 'core-rails-pack', 'Essential Support Rails', 'Barras de apoyo esenciales', 'Support rail starter', 'Adding the agreed grab bars or support rails after checking placement, wall strength and everyday use.', 'Añade las barras de apoyo o pasamanos acordados tras revisar colocación, resistencia de la pared y uso diario.', 'Adds reliable handholds where balance, transfers or short steps need quick support.', 'Añade puntos de agarre fiables donde el equilibrio, las transferencias o los pasos cortos necesitan apoyo rápido.', 'essential', ['bathroom', 'bedroom', 'living-room', 'entrance'], 400, { grantEligible: true }),
    outcome('starter-core-rail-placement', 'living-room', 'starter-essentials', 'core-rails-pack', 'Placement Check', 'Revisión de colocación', 'Support rail starter', 'Confirming where the included rails will be easiest to reach and safest to use.', 'Confirma dónde las barras incluidas serán más fáciles de alcanzar y más seguras de usar.', 'Makes sure support is positioned where it will actually be used.', 'Asegura que el apoyo se coloque donde realmente se va a usar.', 'essential', ['bathroom', 'bedroom', 'living-room', 'entrance'], 401, { grantEligible: true }),
    ...
    outcome('living-room-easier-sitting-standing', 'living-room', 'home-safety-package', 'living-room-home-safety-package', 'Seating Support', 'Apoyo para sentarse y levantarse', 'Sitting and standing', 'Making the resident’s usual sofa or armchair easier to sit into and stand from.', 'Facilita usar el sofá o sillón habitual para sentarse y levantarse.', 'CasaMia checks the existing seat height and layout, then adds measured risers, support handles and furniture positioning where suitable.', 'CasaMia revisa la altura del asiento y la distribución existente, y añade elevadores medidos, asas de apoyo y mejor colocación del mobiliario cuando encaje.', 'essential', ['living-room'], 400, { legacyId: 'movement-stand-assist', grantEligible: true, requiresCompatibilityCheck: true }),
