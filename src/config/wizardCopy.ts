...
const en: WizardCopy = {
  ...
  userType: { title: 'Who is this for?', body: 'We will adapt the questions to the person and place being reviewed.', options: { me: 'Me', family: 'Someone I help', client: 'My facility or business' } },
  methods: {
    title: 'How would you like to start?',
    body: 'Choose questions, photos, voice or a visit. You can add more detail later if the first answers are not enough.',
    ...
    descriptions: { questions: 'Guided online form', audio: 'Record or upload a short brief', voice: 'Talk through the concern', call: 'Answer a few questions by phone', whatsapp: 'Message us on WhatsApp', callback: 'Choose a convenient time', photos: 'Upload photos or short videos', visit: 'Book a home visit' },
  },
  ...
  photos: {
    ...
    rules: 'JPG, PNG, WebP, MP4, WebM or MOV. Up to 8 files, including 3 videos. Images up to 8 MB, videos up to 50 MB, 100 MB total. Photos are checked securely for visible safety details; files upload privately when you submit.',
    image: 'Photo',
    video: 'Video',
    otherRoom: 'Other',
  ...
  voice: {
    title: 'Talk to Jo',
    body: 'Talk with Jo from CasaMia. Explain what changed, which room worries you, or what daily task feels unsafe.',
  ...
  audio: {
    title: 'Send an audio',
    body: 'Record or upload a short voice note. Tell us what changed, which room worries you, or what daily task feels unsafe.',
    add: 'Upload audio',
    record: 'Record audio',
    stop: 'Stop recording',
    recording: 'Recording…',
  ...
  callback: {
    ...
    confirmation: {
      ...
      body: 'Your request is with CasaMia. We will use your note and preferred time to prepare the call; you do not need to complete the rest of the assessment.',
  ...
  visit: { title: 'Professional home safety visit', price: '{{visitFee}} · {{visitVatPercent}} VAT included · paid in advance', body: 'A CasaMia professional reviews the home room by room.', credit: 'The {{visitFee}} fee is deducted from approved CasaMia work if you continue.', example: 'The visit credit is shown in your proposal.', book: 'Book visit', without: 'Continue without visit', selected: 'Visit selected' },
  contact: { title: 'Where should we send your plan?', body: 'Add the contact details needed to send the plan link and discuss the safest next step.', name: 'Full name', phone: 'Phone', email: 'Email', city: 'City / area', method: 'Preferred contact', consent: 'I agree CasaMia may contact me about this home-safety plan and next steps.', privacy: 'We use this only to prepare your plan, send the link and contact you about it. We never sell your data.', phoneOrEmail: 'Add a phone number or email.', invalidEmail: 'Enter a valid email address.', required: 'This field is required.', detect: 'Detect', detecting: 'Finding...', detected: 'Location added', detectError: "We couldn't detect your city. Enter it manually." },
  result: {
    title: 'Your room-by-room safety plan', profile: 'Safety profile', recommendedPlan: 'Recommended starting point', improvements: 'Your priority actions', estimated: 'Starting catalogue estimate', priceDisclaimer: 'A conservative starting estimate using the lowest-priced active option for each relevant area. Your final scope is agreed after the home has been reviewed.', immediate: 'Immediate', recommended: 'Recommended', optional: 'Optional',
    ...
    confidence: { early: 'This is a first estimate based on your answers.', supported: 'Photos, notes or voice details made the starting point more specific.', inspection: 'A home visit confirms measurements, installation details and the final quotation.' },
    ...
    recommendationNote: 'Recommended from your answers. Compare the options before choosing.', packagesTitle: 'Recommended starting packages', packagesBody: 'Open a card to see what it covers, why it helps and what CasaMia checks before confirming the final scope.', packageRecommended: 'Recommended for you', packageSelected: 'Selected', packageDetails: 'View package', packageHide: 'Hide package', packageChoose: 'Choose this package', packageIncludes: 'What it covers', packageManagement: 'CasaMia coordination included', grantTitle: 'Could your project qualify for a grant?', grantBody: 'We check likely grant criteria and prepare the application file when the work and authority rules fit.', grantIncluded: 'Grant support is included in the displayed service price.', grantCaveat: 'Approval and the final amount are decided by the relevant authority.', grantLink: 'Check grant eligibility',
  },
  submit: { sending: 'Uploading files and preparing your plan...', success: 'Your request has been sent. CasaMia will review the details and contact you about the next step.', error: 'We could not send this yet. Your answers are saved; keep this page open to retry the selected files.' },
}
...
const es: WizardCopy = {
  ...
  userType: { title: '¿Para quién es?', body: 'Adaptaremos las preguntas a la persona y la vivienda que se revisa.', options: { me: 'Para mí', family: 'Alguien a quien ayudo', client: 'Mi centro o negocio' } },
  methods: { title: '¿Cómo quieres empezar?', body: 'Elige preguntas, fotos, voz o una visita. Podrás añadir más detalles después si las primeras respuestas no bastan.', options: { questions: 'Responder unas preguntas', audio: 'Enviar un audio', voice: 'Hablar con Jo', call: 'Llámanos', whatsapp: 'WhatsApp', callback: 'Te llamamos', photos: 'Fotos o vídeos', visit: 'Programar visita' }, descriptions: { questions: 'Formulario online guiado', audio: 'Graba o sube una nota breve', voice: 'Hablar sobre la preocupación', call: 'Responde unas preguntas por teléfono', whatsapp: 'Escríbenos por WhatsApp', callback: 'Elige el día y la franja horaria', photos: 'Sube fotos o vídeos cortos', visit: 'Reservar una visita a domicilio' } },
  ...
  photos: {
    ...
    rules: 'JPG, PNG, WebP, MP4, WebM o MOV. Hasta 8 archivos, incluidos 3 vídeos. Imágenes de hasta 8 MB, vídeos de hasta 50 MB y 100 MB en total. Revisamos la foto de forma segura para detectar detalles visibles de seguridad; los archivos se suben de forma privada al enviar.',
    image: 'Foto',
    video: 'Vídeo',
    otherRoom: 'Otra',
  ...
  voice: {
    title: 'Habla con Jo',
    body: 'Habla con Jo, el asistente con IA de CasaMia. Explica qué ha cambiado, qué estancia preocupa o qué tarea diaria parece insegura.',
  ...
  audio: {
    ...
    body: 'Graba o sube una nota de voz breve. Cuéntanos qué ha cambiado, qué estancia preocupa o qué tarea diaria parece insegura.',
    add: 'Subir audio',
    record: 'Grabar audio',
  ...
  visit: { title: 'Visita profesional de seguridad', price: '{{visitFee}} · {{visitVatPercent}} de IVA incluido · pago por adelantado', body: 'Un profesional CasaMia revisará la vivienda estancia por estancia.', credit: 'Los {{visitFee}} se descuentan de los trabajos CasaMia aprobados si continúas.', example: 'El descuento de la visita se muestra en tu propuesta.', book: 'Reservar visita', without: 'Continuar sin visita', selected: 'Visita seleccionada' },
  contact: { title: '¿Dónde enviamos tu plan?', body: 'Añade los datos necesarios para enviar el enlace del plan y comentar el siguiente paso más seguro.', name: 'Nombre completo', phone: 'Teléfono', email: 'Email', city: 'Ciudad / zona', method: 'Contacto preferido', consent: 'Acepto que CasaMia contacte conmigo sobre este plan de seguridad y los siguientes pasos.', privacy: 'Solo usamos estos datos para preparar tu plan, enviar el enlace y contactarte sobre él. Nunca los vendemos.', phoneOrEmail: 'Añade un teléfono o email.', invalidEmail: 'Introduce un email válido.', required: 'Este campo es obligatorio.', detect: 'Detectar', detecting: 'Buscando...', detected: 'Ubicación añadida', detectError: 'No hemos podido detectar tu ciudad. Escríbela manualmente.' },
  result: { title: 'Tu plan de seguridad por estancia', profile: 'Perfil de seguridad', recommendedPlan: 'Punto de partida recomendado', improvements: 'Tus acciones prioritarias', estimated: 'Estimación inicial del catálogo', priceDisclaimer: 'Estimación inicial conservadora basada en la opción activa de menor precio para cada zona relevante. Acordaremos el alcance final después de revisar la vivienda.', immediate: 'Inmediato', recommended: 'Recomendado', optional: 'Opcional', profiles: { prevention: 'Enfoque preventivo', moderate: 'Necesidades moderadas', 'high-priority': 'Mejoras prioritarias', 'smart-safety': 'Seguridad inteligente recomendada', business: 'Soporte profesional' }, plans: { assessment: 'Plan de evaluación', 'home-safety': 'Plan de seguridad del hogar', 'smart-safety': 'Plan de seguridad inteligente', 'business-consultation': 'Consulta profesional' }, confidence: { early: 'Esta es una primera estimación basada en tus respuestas.', supported: 'Las fotos, notas o detalles de voz hacen más específico el punto de partida.', inspection: 'Una visita confirma medidas, detalles de instalación y presupuesto final.' }, bookVisit: 'Reservar visita', requestProposal: 'Solicitar propuesta', speak: 'Hablar con CasaMia', business: 'Reservar consulta profesional', email: 'Enviar mi plan', recommendationNote: 'Recomendado según tus respuestas. Compara las opciones antes de elegir.', packagesTitle: 'Paquetes iniciales recomendados', packagesBody: 'Abre una tarjeta para ver qué cubre, por qué ayuda y qué revisa CasaMia antes de confirmar el alcance final.', packageRecommended: 'Recomendado para ti', packageSelected: 'Seleccionado', packageDetails: 'Ver paquete', packageHide: 'Ocultar paquete', packageChoose: 'Elegir este paquete', packageIncludes: 'Qué cubre', packageManagement: 'Coordinación CasaMia incluida', grantTitle: '¿Tu proyecto puede recibir ayudas?', grantBody: 'Revisamos criterios probables de ayuda y preparamos el expediente cuando la obra y las reglas encajan.', grantIncluded: 'El apoyo para ayudas está incluido en el precio del servicio mostrado.', grantCaveat: 'La administración competente decide la concesión y el importe final.', grantLink: 'Comprobar ayudas' },
  submit: { sending: 'Subiendo archivos y preparando tu plan...', success: 'Solicitud enviada. CasaMia revisará los detalles y contactará contigo sobre el siguiente paso.', error: 'No hemos podido enviarla todavía. Tus respuestas están guardadas; mantén esta página abierta para reintentar los archivos.' },
}
