...
const en: WizardCopy = {
  ...
  result: {
    ...
    confidence: { early: 'Based on the information provided, this is an early estimate.', supported: 'We used your answers and supporting information to improve this estimate.', inspection: 'Your on-site inspection turns this into final recommendations and a quotation.' },
    ...
    recommendationNote: 'Recommended from your answers. Compare every option below.', packagesTitle: 'Recommended catalogue packages', packagesBody: 'These packages are selected from the live CasaMia service catalogue. Open a card to see current outcomes.', packageRecommended: 'Recommended for you', packageSelected: 'Selected', packageDetails: 'View package', packageHide: 'Hide package', packageChoose: 'Choose this package', packageIncludes: 'Catalogue outcomes', packageManagement: 'Managed service included', grantTitle: 'Could your project qualify for a grant?', grantBody: 'We check possible support and manage the grant process when applicable.', grantIncluded: 'Grant management is included in the displayed service price.', grantCaveat: 'Approval and the final amount are decided by the relevant authority.', grantLink: 'Check grant eligibility',
  },
