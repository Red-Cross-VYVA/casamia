...
const en: WizardCopy = {
  ...
  areas: {
    ...
    packageIntro: 'These are the current active outcomes from our catalogue. Your final package will be tailored after we review the home.',
    currentOptions: 'active outcomes',
  ...
  visit: { title: 'Professional home safety visit', price: '99 EUR', body: 'A CasaMia professional reviews the home room by room.', credit: 'The 99 EUR fee is deducted from approved CasaMia work above 150 EUR.', example: 'Example: on a 650 EUR project, 551 EUR remains after the visit credit.', book: 'Book visit', without: 'Continue without visit', selected: 'Visit selected' },
  ...
  result: {
    title: 'Your personalised home safety plan', profile: 'Safety profile', recommendedPlan: 'Recommended starting point', improvements: 'Your priority actions', estimated: 'Live catalogue estimate', priceDisclaimer: 'A conservative starting estimate using the lowest-priced active option for each relevant area. Your final scope is confirmed after reviewing the home. Fine print: package prices are for a coordinated outcome, not an item-by-item basket. CasaMia may adjust or substitute included items after the review; credits apply only when reduced scope materially lowers CasaMia product, installation, or partner cost.', immediate: 'Immediate', recommended: 'Recommended', optional: 'Optional',
...
const es: WizardCopy = {
  ...
  areas: {
    ...
    packageIntro: 'Estos son los resultados activos de nuestro catálogo. Adaptaremos el paquete final después de revisar la vivienda.',
    currentOptions: 'resultados activos',
