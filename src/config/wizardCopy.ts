...
const en: WizardCopy = {
  entry: {
    ...
    title: "Find the safest next step at home",
    body: 'Answer a few questions, add photos, or describe what feels difficult. We turn it into a clear room-by-room starting point.',
    start: 'Start',
  ...
  userType: { title: 'Who should the plan help?', body: 'Choose the closest match so the questions fit the person, home and decision you need to make.', options: { me: 'Me', family: 'Someone I help', client: 'My facility or business' } },
  methods: {
    ...
    descriptions: { questions: 'Best for a quick first plan', audio: 'Explain the concern in your words', voice: 'Talk through the room or routine', call: 'Answer a few questions by phone', whatsapp: 'Message us when convenient', callback: 'Choose a convenient time', photos: 'Show the rooms that worry you', visit: 'Measure and check the home in person' },
  },
  ...
  result: {
    title: 'Your room-by-room safety plan', profile: 'Safety profile', recommendedPlan: 'Recommended starting point', improvements: 'What to address first', estimated: 'Early price guide', priceDisclaimer: 'This early guide uses current catalogue options for the areas you selected. A final price is only confirmed after measurements, photos or a visit support the plan.', immediate: 'Immediate', recommended: 'Recommended', optional: 'Optional',
...
const es: WizardCopy = {
  entry: { eyebrow: 'Plan guiado CasaMia', title: 'Encuentra el siguiente paso más seguro en casa', body: 'Responde unas preguntas, añade fotos o describe qué se hace difícil. Lo convertimos en un punto de partida claro por estancias.', start: 'Empezar', time: 'La mayoría termina en menos de 3 minutos.', resume: 'Continuar plan guardado' },
