...
const en: WizardCopy = {
  ...
  visit: { title: 'Professional home safety visit', price: '{{visitFee}} · {{visitVatPercent}} VAT included · paid in advance', body: 'A CasaMia professional reviews the home room by room.', credit: 'The {{visitFee}} fee is deducted from approved CasaMia installation if you continue.', example: 'The visit credit is shown in your proposal.', book: 'Book visit', without: 'Continue without visit', selected: 'Visit selected' },
  ...
  result: {
    ...
    bookVisit: 'Book home visit', requestProposal: 'Review next steps', speak: 'Speak to CasaMia', business: 'Book business consultation', email: 'Email my plan',
    recommendationNote: 'Recommended from your answers. Compare the options before choosing.', packagesTitle: 'Recommended starting packages', packagesBody: 'Open a card to see what it covers, why it helps and what CasaMia checks before the final plan is confirmed.', packageRecommended: 'Recommended for you', packageSelected: 'Selected', packageDetails: 'View package', packageHide: 'Hide package', packageChoose: 'Choose this package', packageIncludes: 'What it covers', packageManagement: 'CasaMia coordination included', grantTitle: 'Could your project qualify for a grant?', grantBody: 'We check likely grant criteria and prepare the application file when the installation and authority rules fit.', grantIncluded: 'Grant support is included in the displayed service price.', grantCaveat: 'Approval and the final amount are decided by the relevant authority.', grantLink: 'Check grant eligibility',
  },
  submit: { sending: 'Uploading files and preparing your plan...', success: 'Your details have been sent. CasaMia will review them and contact you about the next step.', error: 'We could not send this yet. Your answers are saved; keep this page open to retry the selected files.' },
}
...
const es: WizardCopy = {
  ...
  voice: {
    title: 'Habla con Jo',
    body: 'Habla con Jo de CasaMia. Explica qué ha cambiado, qué estancia preocupa o qué tarea diaria parece insegura.',
