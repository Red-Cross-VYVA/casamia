...
const en: WizardCopy = {
  ...
  areas: {
    ...
    packageIntro: 'These are the services CasaMia can usually combine for this area. The final recommendation depends on the room, measurements and daily routine.',
  ...
  notes: { title: 'Anything else we should know?', body: 'A short note is enough.', placeholder: 'Example: where movement feels unsafe, what changed recently, or which room worries you most...' },
  client: {
  ...
  voice: {
    title: 'Talk to Jo',
    body: 'Have a natural conversation with Jo, CasaMia’s AI assistant. Explain what changed, which room worries you, or what daily task feels unsafe.',
  ...
  callback: {
    ...
    privacy: 'We use these details only to arrange your call and handle this home-safety request. We never sell your data.',
    ...
    confirmation: {
      ...
      date: 'Preferred day',
      time: 'Preferred time',
      reassurance: 'We will only use these details to arrange your call and handle this home-safety request.',
  ...
  result: {
    ...
    confidence: { early: 'This is an early estimate based on your answers.', supported: 'Photos, notes or voice details made this estimate more specific.', inspection: 'A home visit turns this into final recommendations and a quotation.' },
...
const es: WizardCopy = {
  ...
  areas: {
    ...
    packageIntro: 'Estos son los servicios que CasaMia suele combinar para esta zona. La recomendación final depende de la estancia, las medidas y la rutina diaria.',
  ...
  notes: { title: '¿Hay algo más que debamos saber?', body: 'Una nota breve es suficiente.', placeholder: 'Ejemplo: dónde el movimiento parece inseguro, qué ha cambiado recientemente o qué estancia preocupa más...' },
  ...
  callback: {
    ...
    privacy: 'Solo usamos estos datos para organizar la llamada y gestionar esta solicitud de seguridad en casa. Nunca los vendemos.',
    ...
    confirmation: {
      ...
      date: 'Día preferido',
      time: 'Hora preferida',
      reassurance: 'Solo usaremos estos datos para organizar la llamada y gestionar esta solicitud de seguridad en casa.',
  ...
  contact: { title: '¿Dónde enviamos tu plan?', body: 'Añade los datos necesarios para enviar el plan y comentar el siguiente paso.', name: 'Nombre completo', phone: 'Teléfono', email: 'Email', city: 'Ciudad / zona', method: 'Contacto preferido', consent: 'Acepto que CasaMia contacte conmigo sobre mi plan de seguridad.', privacy: 'Solo usamos estos datos para preparar tu plan y contactarte. Nunca los vendemos.', phoneOrEmail: 'Añade un teléfono o email.', invalidEmail: 'Introduce un email válido.', required: 'Este campo es obligatorio.', detect: 'Detectar', detecting: 'Buscando...', detected: 'Ubicación añadida', detectError: 'No hemos podido detectar tu ciudad. Escríbela manualmente.' },
  result: { title: 'Tu plan de seguridad por estancia', profile: 'Perfil de seguridad', recommendedPlan: 'Punto de partida recomendado', improvements: 'Tus acciones prioritarias', estimated: 'Estimación del catálogo', priceDisclaimer: 'Estimación inicial conservadora basada en la opción activa de menor precio para cada zona relevante. Acordaremos el alcance final después de revisar la vivienda.', immediate: 'Inmediato', recommended: 'Recomendado', optional: 'Opcional', profiles: { prevention: 'Enfoque preventivo', moderate: 'Necesidades moderadas', 'high-priority': 'Mejoras prioritarias', 'smart-safety': 'Seguridad inteligente recomendada', business: 'Soporte profesional' }, plans: { assessment: 'Plan de evaluación', 'home-safety': 'Plan de seguridad del hogar', 'smart-safety': 'Plan de seguridad inteligente', 'business-consultation': 'Consulta profesional' }, confidence: { early: 'Esta es una estimación inicial basada en tus respuestas.', supported: 'Las fotos, notas o detalles de voz han hecho la estimación más específica.', inspection: 'Una visita convierte esto en recomendaciones y presupuesto finales.' }, bookVisit: 'Reservar visita', requestProposal: 'Solicitar propuesta', speak: 'Hablar con CasaMia', business: 'Reservar consulta profesional', email: 'Enviar mi plan', recommendationNote: 'Recomendado según tus respuestas. Compara las opciones antes de elegir.', packagesTitle: 'Paquetes iniciales recomendados', packagesBody: 'Abre una tarjeta para ver qué cubre, por qué ayuda y qué revisa CasaMia antes de confirmar el alcance final.', packageRecommended: 'Recomendado para ti', packageSelected: 'Seleccionado', packageDetails: 'Ver paquete', packageHide: 'Ocultar paquete', packageChoose: 'Elegir este paquete', packageIncludes: 'Qué cubre', packageManagement: 'Coordinación CasaMia incluida', grantTitle: '¿Tu proyecto puede recibir ayudas?', grantBody: 'Revisamos la posible ruta de ayuda y preparamos el expediente cuando la obra y las reglas encajan.', grantIncluded: 'El apoyo para ayudas está incluido en el precio del servicio mostrado.', grantCaveat: 'La administración competente decide la concesión y el importe final.', grantLink: 'Comprobar ayudas' },
