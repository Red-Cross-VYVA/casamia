...
const plansCatalogueIntroCopy: Record<'en' | 'es', PlansCatalogueIntroCopy> = {
  en: {
    ...
    heroTitle: 'Home safety options, room by room.',
    heroBody: 'Choose a room or safety area to see what CasaMia can review, price and coordinate after checking fit.',
    browseCta: 'Explore services',
    catalogueGuide: {
      eyebrow: 'Before you browse',
      title: 'Pick rooms. Save one clear selection.',
      body: 'Start with one room or combine areas across the home before CasaMia confirms scope and price.',
      points: ['One room', 'Several areas', 'One clear selection'],
  ...
  es: {
    ...
    heroTitle: 'Opciones de seguridad, estancia por estancia.',
    heroBody: 'Elige una estancia o zona de seguridad para ver qué puede revisar, presupuestar y coordinar CasaMia tras comprobar el encaje.',
    browseCta: 'Ver servicios',
    catalogueGuide: {
      eyebrow: 'Antes de ver el cat\u00e1logo',
      title: 'Elige zonas. Guarda una selección clara.',
      body: 'Empieza con una estancia o combina varias zonas antes de que CasaMia confirme alcance y precio.',
      points: ['Una estancia', 'Varias zonas', 'Una selección clara'],
...
function localizePlanDetailItem(item: string, language: 'en' | 'es') {
  ...
  const translations: Record<string, string> = {
    ...
    'Family or carer alert setup': 'Avisos para contactos autorizados',
    ...
    'Resident phone alert setup': 'Avisos al telefono de la persona en casa',
...
const plansCopy: Record<'en' | 'es', PlansCopy> = {
  en: {
    ...
    backToBuilder: 'Edit selection',
    backToRooms: 'Back to rooms',
    builderEyebrow: 'Plan builder',
    builderTitle: 'Choose rooms',
    consent: 'CasaMia may contact me about this plan.',
    contactIntro: 'Add contact details so CasaMia can send a secure link with your selected rooms, add-ons and review notes.',
    contactStepEyebrow: 'Secure plan link',
    contactTitle: 'Receive your selection',
    continueToReview: 'Review selections',
    coreIncluded: 'Included scope',
    closeDetails: 'Close',
    createDraft: 'Create secure link',
    creatingDraft: 'Creating secure link...',
    draftCreated: 'Secure link created. Open it to review selected rooms, add-ons and what CasaMia should check next.',
    email: 'Email',
    ...
    grantBody: 'Check documents and criteria before installation is confirmed.',
    grantCta: 'Start grant check',
    grantEyebrow: 'Grant readiness',
    grantTitle: 'Grants may apply.',
    heroSignals: ['Selection first', 'Scope checked before price', 'Optional add-ons separate'],
    ...
    heroReviewTitle: 'Save your rooms and review notes.',
    ...
    reviewCtaBody: 'Next, share contact details so CasaMia can send a secure link with your rooms, quantities, add-ons and review notes.',
    ...
    reviewStepTitle: 'Review your selection',
    roomDescriptions: {
      bathroom:
    ...
    seeDraft: 'Open plan',
    selectedPackages: 'Selected scope',
    specialistTitle: 'Needs review',
    summaryEmptyRooms: 'Choose rooms to start',
    summaryModulesTitle: 'Plan details',
    summaryMoreItems: 'more',
    summaryNextBody: 'Your secure link is created from the selected rooms, quantities, add-ons and review notes.',
  ...
  es: {
    backToBuilder: 'Editar selección',
    backToRooms: 'Volver a estancias',
    contactIntro: 'Añade tus datos para recibir un enlace seguro con las estancias elegidas, extras y notas de revisión.',
    ...
    coreIncluded: 'Alcance incluido',
    closeDetails: 'Cerrar',
    createDraft: 'Crear enlace seguro',
    creatingDraft: 'Creando enlace seguro...',
    draftCreated: 'Enlace seguro creado. Ábrelo para revisar estancias, extras y qué debe comprobar CasaMia después.',
    email: 'Email',
    ...
    heroSignals: ['Selección primero', 'Alcance revisado antes del precio', 'Extras opcionales separados'],
    heroPhotoAlt: 'Especialista de CasaMia revisando una cocina en casa',
    heroReviewBody:
    ...
    heroReviewTitle: 'Guarda estancias y notas de revisión.',
    ...
    selectedPackages: 'Alcance seleccionado',
    specialistTitle: 'Requiere revisión',
    summaryEmptyRooms: 'Elige estancias para empezar',
    summaryModulesTitle: 'Incluido en esta selección',
    summaryMoreItems: 'más',
    summaryNextBody: 'El enlace se crea con las estancias, cantidades, extras y notas de revisión.',
...
export function PlansPage() {
  ...
  const copy = useMemo<PlansCopy>(() => ({
    ...
    ...(language === 'es'
      ? {
          ...
          heroSignals: ['Selección primero', 'Alcance revisado antes del precio', 'Extras opcionales'],
          ...
          reviewCtaBody: 'Comparte tus datos para crear un enlace seguro con las estancias, cantidades, extras y notas de revisión.',
          reviewCtaTitle: '¿Listo para guardar esta selección?',
      ...
      : {
          ...
          heroSignals: ['Selection first', 'Scope checked before price', 'Optional extras'],
  ...
  const detailCopy = language === 'es'
    ? {
        ...
        coreTab: 'Alcance incluido',
        description: 'Qué mejora',
        includes: 'Incluido en este alcance',
        itemIncludes: 'Incluido para este elemento',
        next: 'Siguiente',
        noDetailItems: 'No hay elementos para mostrar en esta sección.',
        orderPackage: (roomLabel: string) => `Añadir ${roomLabel.toLocaleLowerCase('es-ES')}`,
        optionalTab: 'Extras opcionales',
        previous: 'Anterior',
        requestReview: 'Revisar este extra',
        reviewBody: 'Puedes guardar el alcance incluido ahora. Revisaremos este extra contigo y acordaremos medidas, encaje y precio antes de añadirlo.',
    ...
    : {
        ...
        coreTab: 'Included scope',
        description: 'What this changes',
        includes: 'Included in this scope',
        itemIncludes: 'Included for this item',
        next: 'Next',
        noDetailItems: 'No items to show in this section.',
        orderPackage: (roomLabel: string) => `Add ${roomLabel}`,
        optionalTab: 'Optional add-ons',
        previous: 'Previous',
        requestReview: 'Review this add-on',
        reviewBody: 'You can save the included scope now. We will review this add-on with you and agree measurements, fit and price before adding it.',
  ...
  const summaryScopeCopy = language === 'es'
    ...
    : {
        ...
        estimateNote: 'VAT included. Package prices cover a coordinated outcome, not an item-by-item basket. Any credit is confirmed during the plan review.',
