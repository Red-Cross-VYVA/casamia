...
const plansCopy: Record<'en' | 'es', PlansCopy> = {
  en: {
    ...
    optionalAddOnsIntro: 'Extra information is required before CasaMia can quote connected support or specialist adaptations.',
  ...
  es: {
    ...
    optionalAddOnsIntro: 'CasaMia necesita información adicional antes de presupuestar el apoyo conectado o las adaptaciones especializadas.',
