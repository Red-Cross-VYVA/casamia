...
function getGrantCopy(language: string) {
  ...
  if (language === 'es') {
    return {
      ...
      fields: {
        ...
        residentAge: 'Edad de la persona',
        mobility: 'Movilidad',
      ...
      options: {
        ...
        ownership: [
          { value: 'Owner occupied', label: 'Propietario ocupante' },
      ...
      calculation: {
        reasons: {
          ...
          age75: 'Una persona de 75+ suele ser una señal fuerte para ayudas de accesibilidad.',
          age65: 'Una persona mayor de 65 puede encajar en muchos criterios de accesibilidad.',
          family: 'Las solicitudes gestionadas por familiares son habituales, pero conviene confirmar los datos de la persona.',
  ...
  return {
    ...
    progress: ['Home', 'Person', 'Needs', 'Report', 'Send'],
    steps: {
      home: {
        kicker: 'Step 1',
    ...
    calculation: {
      reasons: {
        ...
        family: 'Family-led applications are common, but CasaMia should confirm the person\'s details.',
