...
function getGrantCopy(language: string) {
    ...
    return {
      ...
      result: {
        ...
        research: {
          ...
          needsDataBody: 'Completa estos puntos para que CasaMia pueda investigar los criterios relevantes.',
          missingTitle: 'Datos pendientes',
          routesTitle: 'Opciones posibles',
  ...
  return {
    ...
    delivery: {
      ...
      whatsapp: 'Your report is saved for WhatsApp delivery. The message will contain only a secure report link.',
    },
    errors: {
    ...
    calculation: {
      reasons: {
        ...
        mobilityNeed: 'Current mobility needs make accessibility adaptations easier to justify.',
      ...
      casamiaManagement: {
        base: [
          ...
          'Turn the need into a priced plan that states the requested adaptations, evidence and reason for each item.',
        ],
        watch: [
          'Start with the free online safety report so the first adaptation priorities are clearer.',
