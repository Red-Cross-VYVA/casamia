...
const servicesPageCopy: Record<'en' | 'es', ServicesPageCopy> = {
  en: {
    ...
    currentOptions: 'core outcomes and add-ons available now',
    ...
    includedItemSingular: 'core outcome',
    includedItemPlural: 'core outcomes',
    addOnSingular: 'optional add-on',
    addOnPlural: 'optional add-ons',
    selectedEyebrow: 'Package area',
    coreComponent: 'Core package outcome',
  ...
  es: {
    ...
    currentOptions: 'resultados base y extras disponibles',
    ...
    includedItemSingular: 'resultado base',
    includedItemPlural: 'resultados base',
    addOnSingular: 'extra opcional',
    addOnPlural: 'extras opcionales',
    selectedEyebrow: 'Zona del paquete',
    coreComponent: 'Resultado del paquete base',
    optionalComponent: 'Extra opcional',
    included: 'Alcance habitual',
