...
const pageCopy = {
  en: {
    ...
    comparisonBody:
      'Short guides for the moments when you are choosing between two very different next steps.',
  ...
  es: {
    ...
    comparisonBody:
      'Guías breves para cuando hay que elegir entre dos caminos distintos.',
