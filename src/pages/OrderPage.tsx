...
const orderCopy: Record<'en' | 'es', OrderCopy> = {
  en: {
    ...
    whatsappTitle: 'Email',
    whatsappBody: 'Send the home location, main concern and preferred contact time so CasaMia can reply with the right route.',
  ...
  es: {
    ...
    whatsappTitle: 'Email',
    whatsappBody: 'Envía la ubicación, la preocupación principal y cuándo contactarte para responder con la ruta adecuada.',
    ...
    formBody: 'Elige cuándo debe llamar CasaMia para confirmar la vivienda, la preocupación y el siguiente paso.',
    name: 'Nombre',
