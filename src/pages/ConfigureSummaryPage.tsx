...
const summaryCopy = {
  ...
  es: {
    ...
    body: 'Revisa las mejoras seleccionadas, la estimación y los puntos que CasaMia debe confirmar antes del precio final.',
    print: 'Imprimir',
    emptyTitle: 'Aún no hay mejoras seleccionadas',
    emptyBody: 'Vuelve y selecciona primero las estancias o rutas que necesitan revisión.',
