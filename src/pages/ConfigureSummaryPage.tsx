...
const summaryCopy = {
  en: {
    ...
    body: 'Review the selected improvements, estimate and anything still to check before the final quote.',
    print: 'Print',
    emptyTitle: 'No improvements selected yet',
    emptyBody: 'Go back to choose the rooms and safety services you want reviewed.',
  ...
  es: {
    ...
    body: 'Revisa las mejoras seleccionadas, la estimación y lo que queda por comprobar antes del presupuesto final.',
    print: 'Imprimir',
    emptyTitle: 'Aún no hay mejoras seleccionadas',
    emptyBody: 'Vuelve para elegir las estancias y servicios de seguridad que quieres revisar.',
