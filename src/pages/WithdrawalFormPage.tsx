...
const withdrawalCopy = {
  en: {
    ...
    title: 'Cancel or withdraw from a CasaMia order',
    body:
      'Use this form if you want to tell CasaMia you are cancelling or withdrawing from an eligible order. Submit it online, download a copy for your records, or send the same details by email or post.',
    optionalComments: 'Anything else CasaMia should know',
    submit: 'Submit form',
    download: 'Download printable copy',
    submitted:
      'Your request was submitted. Download or save a copy for your records.',
    submissionError: 'We could not submit the form. Please try again or use the email or postal address below.',
    localOnly:
      'This form has been prepared on this device. To make sure CasaMia receives it, send the details by email or post, or use the online submission when available.',
  ...
  es: {
    ...
    title: 'Cancelar o desistir de un pedido CasaMia',
    body:
      'Usa este formulario si quieres comunicar a CasaMia que cancelas o desistes de un pedido elegible. Envíalo online, descarga una copia para tus registros o manda los mismos datos por email o correo postal.',
    optionalComments: 'Algo más que CasaMia deba saber',
    submit: 'Enviar formulario',
    download: 'Descargar copia imprimible',
    submitted:
      'Tu solicitud se envió. Descarga o guarda una copia para tus registros.',
    submissionError: 'No pudimos enviar el formulario. Inténtalo de nuevo o usa el email o la dirección postal indicados abajo.',
    localOnly:
      'Este formulario se ha preparado en este dispositivo. Para asegurarte de que CasaMia lo recibe, envía los datos por email o correo postal, o usa el envío online cuando esté disponible.',
