...
const checkoutCopy = {
  en: {
    ...
    quoteBody: 'Use this when the scope looks clear enough for CasaMia to confirm remotely.',
  ...
  es: {
    ...
    quoteBody: 'Úsalo cuando el alcance parece suficientemente claro para que CasaMia lo confirme a distancia.',
