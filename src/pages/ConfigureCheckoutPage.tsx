...
const checkoutCopy = {
  en: {
    eyebrow: 'Final step',
    title: 'Decide whether the next step needs a visit.',
    body:
      'Review the selected improvements, then choose a remote quote or a measured home visit when fit, access or measurements still need checking.',
    selectedTitle: 'Selected improvements',
    selectedBody: 'These are the safety services CasaMia will confirm before final pricing.',
    selected: 'selected',
    ...
    quoteTitle: 'Get a remote review',
    quoteBody: 'Use this when photos, answers and selected items give CasaMia enough context to review the plan remotely.',
    amountNow: 'Amount payable now:',
    vatIncluded: 'VAT included',
    quoteFree: '€0',
    saving: 'Saving...',
    requestQuote: 'Get remote review',
    visitTitle: 'Reserve home visit',
    visitBody: 'Use this when measurements, access, fixing points or product fit should be checked in the home. The visit fee is deducted if you continue.',
    preparing: 'Preparing...',
    ...
    requestError: 'We could not send your plan to CasaMia. Please try again.',
  ...
  es: {
    ...
    selectedBody: 'Estos son los servicios de seguridad que CasaMia confirmará antes del precio final.',
    ...
    quoteTitle: 'Revisión a distancia',
    quoteBody: 'Úsalo cuando fotos, respuestas y mejoras elegidas dan suficiente contexto para que CasaMia confirme el siguiente presupuesto a distancia.',
    amountNow: 'Importe a pagar ahora:',
    vatIncluded: 'IVA incluido',
    quoteFree: '€0',
    saving: 'Guardando...',
    requestQuote: 'Pedir revisión',
    visitTitle: 'Reservar visita a domicilio',
    visitBody: 'Úsalo cuando conviene comprobar medidas, acceso, puntos de fijación o encaje de productos en la vivienda. La visita se descuenta si continúas.',
    ...
    requestError: 'No se pudo enviar tu plan a CasaMia. Inténtalo de nuevo.',
