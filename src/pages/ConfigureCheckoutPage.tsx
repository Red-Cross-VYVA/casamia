...
const checkoutCopy = {
  en: {
    ...
    selectedBody: 'These are the safety services we will review for your quote.',
    selected: 'selected',
    ...
    quoteBody: 'Best if your answers are enough to agree the next step remotely.',
    ...
    visitBody: 'We check measurements, access and product fit at home. The visit fee is deducted if you continue.',
    preparing: 'Preparing...',
  ...
  es: {
    ...
    selectedBody: 'Estos son los servicios de seguridad que revisaremos para tu presupuesto.',
    ...
    quoteBody: 'Ideal si tus respuestas son suficientes para acordar el siguiente paso a distancia.',
    ...
    visitBody: 'Revisamos medidas, acceso y encaje de productos en la vivienda. La visita se descuenta si continúas.',
