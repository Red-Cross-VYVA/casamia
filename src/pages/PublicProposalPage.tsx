...
export function PublicProposalPage() {
  ...
  const copy = isSpanish
    ? {
        ...
        acceptedBody: 'Tu propuesta está aceptada. Continúa con el pago seguro para reservar la planificación de la instalación.',
        ...
        acceptBody:
          'Al aceptar, confirmas que apruebas las adaptaciones mostradas, exclusiones o partidas pendientes, condiciones de pago y términos de servicio aplicables.',
    ...
    : {
        ...
        acceptedBody: 'Your proposal is accepted. Continue to secure payment to reserve installation planning.',
