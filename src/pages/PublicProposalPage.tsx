...
export function PublicProposalPage() {
  ...
  const copy = isSpanish
    ? {
        title: 'Tu plan CasaMia',
        loadError: 'No hemos podido cargar este enlace del plan. Contacta con CasaMia para recibir ayuda.',
        acceptError: 'No hemos podido aprobar este plan online. Contacta con CasaMia y te ayudaremos.',
        loading: 'Cargando tu plan',
        unavailableTitle: 'Enlace del plan no disponible',
        contact: 'Contactar con CasaMia',
        readyTitle: 'Tu plan CasaMia está listo',
        readyBody:
          'Revisa las adaptaciones incluidas, lo que queda pendiente de medición, las partidas opcionales, las condiciones de pago y los términos aplicables. Acepta solo cuando quieras aprobar este plan y pasar al pago seguro.',
        pendingTitle: 'Este enlace todavía no está listo para aceptar',
        pendingBody:
          'Si has recibido este enlace, contacta con CasaMia para activar el plan o generar uno nuevo desde Planes.',
        ...
        paymentError: 'El plan está aprobado, pero no hemos podido abrir el pago seguro. Inténtalo de nuevo.',
    ...
    : {
        ...
        readyTitle: 'Your CasaMia plan is ready',
        readyBody:
          'Review the included adaptations, what still needs measurement, optional items, payment terms and applicable service terms. Accept only when you want to approve this plan and continue to secure payment.',
        pendingTitle: 'This link is not ready for acceptance yet',
        pendingBody:
          'If you received this link, contact CasaMia to activate the plan or generate a fresh one from Plans.',
        ...
        paymentError: 'Your plan is approved, but secure payment could not be opened. Please try again.',
