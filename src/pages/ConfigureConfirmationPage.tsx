...
const confirmationCopy = {
  en: {
    ...
    qty: 'Qty',
    empty:
      'CasaMia has saved your plan. We will confirm the exact improvements before installation starts.',
    ...
    paymentPaid: 'Payment received. Your home visit is ready for scheduling.',
  ...
  es: {
    ...
    qty: 'Cant.',
    empty:
      'CasaMia ha guardado tu plan. Confirmaremos las mejoras exactas antes de iniciar cualquier instalación.',
    confirmBefore: 'A confirmar antes de la instalación',
    noPayload: 'No se encontró un plan guardado. Vuelve al configurador para preparar uno nuevo.',
    back: 'Volver al configurador',
    home: 'Volver al inicio',
    paymentChecking: 'Confirmando tu pago seguro con Stripe...',
    paymentPaid: 'Pago recibido. Tu visita a domicilio está lista para programarse.',
