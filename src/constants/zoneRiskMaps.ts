...
export const zoneRiskMaps: Record<ZoneRiskArea, ZoneRiskMap> = {
  ...
  connected: {
    ...
    copy: {
      en: {
        eyebrow: 'Connected-care map',
        title: 'Technology works best when it supports real routines.',
        body: 'Useful connected care supports the moments where assistance, health readings, light, awareness or family follow-up matter: mornings, medication, night movement, doors, water, emergencies and check-ins.',
        imageAlt: 'Smart safety devices supporting safer routines at home',
        risks: ['Help out of reach', 'Vitals not followed', 'Medication forgotten', 'No night visibility', 'Hidden water leak', 'Door activity unclear', 'Hard-to-use controls'],
        mapLabels: [],
        legend: [],
      },
      es: {
        eyebrow: 'Mapa de cuidado conectado',
        title: 'La tecnología funciona mejor cuando apoya rutinas reales.',
        body: 'El cuidado conectado útil acompaña momentos donde importan la asistencia, las constantes, la luz, el aviso o el seguimiento familiar: mañanas, medicación, movimiento nocturno, puertas, agua, emergencias y revisiones.',
        imageAlt: 'Dispositivos de seguridad conectada para apoyar rutinas más seguras en casa',
        risks: ['Ayuda fuera de alcance', 'Constantes sin seguimiento', 'Medicación olvidada', 'Poca visibilidad nocturna', 'Fuga de agua oculta', 'Actividad de puerta poco clara', 'Controles difíciles'],
        mapLabels: [],
        legend: [],
      },
    },
