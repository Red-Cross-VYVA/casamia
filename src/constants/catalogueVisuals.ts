...
export const catalogueOutcomeImages: Record<string, string> = {
  ...
  'bathroom-vertical-support': serviceProductImage('vertical-support-rail-modern'),
  'bathroom-vertical-support-rail': serviceProductImage('vertical-support-rail-modern'),
  ...
  'bedroom-door-accessibility': '/images/service-card-products/bedroom-wide-doorway.jpg',
  ...
  'entrance-wider-doorway': '/images/service-card-products/entrance-door-clearance.jpg',
