...
export const catalogueOutcomeImages: Record<string, string> = {
  ...
  'entrance-step-handrail': serviceProductImage('stair-support'),
  ...
  'starter-entrance-support-rail': serviceProductImage('stair-support'),
  'starter-entrance-threshold-visibility': serviceProductImage('threshold-reduction'),
  'starter-entrance-mat-basics': serviceProductImage('rug-grip'),
