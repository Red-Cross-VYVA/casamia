...
const specialistCopy = {
  en: {
    ...
    body: 'Describe the room or routine that worries you, then ask what to check, photograph or book next.',
  ...
  es: {
    ...
    body: 'Describe la estancia o rutina que preocupa y pregunta qué revisar, fotografiar o reservar después.',
    ...
    privacy: 'La voz empieza solo cuando pulsas iniciar. No compartas datos médicos ni de pago.',
    saved: 'Conversación terminada',
    speaking: 'Hablando',
    start: 'Iniciar voz',
