...
const selfInspectionCopy = {
  en: {
    ...
    intro: 'Start with the home basics, then review daily needs and each key room.',
    livesWith: 'Lives with',
    livesWithPlaceholder: 'Household',
    mainConcern: 'Main concern or extra context',
    mainConcernPlaceholder: 'Example: daytime movement is fine, but getting to the bathroom at night feels risky.',
    ...
    reportEmpty: 'Items marked Needs review or Not sure will appear here.',
    reportContext: 'Home and person summary',
    reportPreview: 'Report preview',
    reportReady: 'Summary ready to send',
    reportStatus: 'Nothing flagged yet',
    residentContext: 'Person and routine',
    residentNeeds: 'Person and routine',
    ...
    nextRoom: 'Next room',
    submit: 'Send to CasaMia',
    submitIncomplete: 'Add your name, phone or email, and consent before sending the summary.',
    submitReady: 'Sent to CasaMia. We will review the flagged rooms and follow up with clear safety priorities.',
  ...
  es: {
    ...
    intro: 'Empieza por la vivienda, revisa necesidades diarias y después cada zona clave.',
    livesWith: 'Convive con',
    livesWithPlaceholder: 'Hogar',
    mainConcern: 'Preocupación principal',
    mainConcernPlaceholder: 'Ejemplo: de día se mueve bien, pero ir al baño por la noche se siente arriesgado.',
    ...
    reportReady: 'Resumen listo para enviar',
    reportStatus: 'Sin riesgos marcados',
    residentContext: 'Persona y rutina',
    residentNeeds: 'Persona y rutina',
    ...
    steps: ['Vivienda', 'Persona', 'Zonas', 'Resumen'],
    nextRoom: 'Siguiente zona',
    submit: 'Enviar a CasaMia',
    submitIncomplete: 'Añade tu nombre, teléfono o email, y acepta el consentimiento para enviar el resumen.',
    submitReady: 'Enviado a CasaMia. Revisaremos las zonas marcadas y te enviaremos prioridades claras.',
