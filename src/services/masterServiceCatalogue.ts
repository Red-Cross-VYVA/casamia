...
function getSpanishCapabilityName(capabilityId: string, fallback: string) {
  const names: Record<string, string> = {
    ...
    'anti-fatigue-standing-zone': 'Alfombrilla antifatiga acolchada para la zona principal de trabajo',
    'safer-hob-control': 'Temporizador de corte compatible o controles de placa más seguros',
    'automatic-gas-shutoff': 'Apoyo de corte de gas compatible, cuando aplique',
