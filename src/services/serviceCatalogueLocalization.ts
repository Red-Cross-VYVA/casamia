...
import type { CasaMiaService, EditableServiceCatalogue, ServiceRoom } from '../types/serviceCatalogue'

type LocalizedServiceCopy = Partial<Pick<CasaMiaService, 'category' | 'customerBenefit' | 'includedItems' | 'name' | 'safetyNotice' | 'shortDescription'>>

const spanishServiceCopy: Record<string, LocalizedServiceCopy> = {
...
export function localizeService(service: CasaMiaService, language: string): CasaMiaService {
  ...
  const copy = spanishServiceCopy[service.id]
